...
public class Level24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level24);
        ...
        previewImage.setImageResource(R.drawable.preview_img_24);
        ...
        textDescription.setText(R.string.level_24);
        ...
        textDescriptionEnd.setText(R.string.level_24_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level24.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images24[numLeft]);
        text_left.setText(array.texts24[numLeft]);

        numRight = random.nextInt(20);

        while (array.strong24[numLeft] == array.strong24[numRight]){
            numRight = random.nextInt(20);
        }
        img_right.setImageResource(array.images24[numRight]);
        text_right.setText(array.texts24[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong24[numLeft] < array.strong24[numRight]){
