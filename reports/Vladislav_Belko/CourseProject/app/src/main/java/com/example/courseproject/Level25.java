...
public class Level25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level25);
        ...
        previewImage.setImageResource(R.drawable.preview_img_25);
        ...
        textDescription.setText(R.string.level_25);
        ...
        textDescriptionEnd.setText(R.string.level_25_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level25.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images25[numLeft]);
        text_left.setText(array.texts25[numLeft]);

        numRight = random.nextInt(20);

        while (array.strong25[numLeft] == array.strong25[numRight]){
            numRight = random.nextInt(20);
        }
        img_right.setImageResource(array.images25[numRight]);
        text_right.setText(array.texts25[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong25[numLeft] < array.strong25[numRight]){
