...
public class Level18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_18);
        ...
        textDescription.setText(R.string.level_18);
        ...
        textDescriptionEnd.setText(R.string.level_18_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level18.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images18[numLeft]);
        text_left.setText(array.texts18[numLeft]);
        ...
        text_right.setText(array.texts18[numRight]);
