...
public class Level29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level29);
        ...
        previewImage.setImageResource(R.drawable.preview_img_29);
        ...
        textDescription.setText(R.string.level_29);
        ...
        textDescriptionEnd.setText(R.string.level_29_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level29.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(10);
        img_left.setImageResource(array.images29[numLeft]);
        text_left.setText(array.texts29[numLeft]);
        ...
        text_right.setText(array.texts29[numRight]);
