...
public class Level16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_16);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level16.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(18);
        img_left.setImageResource(array.images16[numLeft]);
        text_left.setText(array.texts16[numLeft]);

        numRight = random.nextInt(18);

        while (array.strong16[numLeft] == array.strong16[numRight]){
            numRight = random.nextInt(18);
        }
        img_right.setImageResource(array.images16[numRight]);
        text_right.setText(array.texts16[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong16[numLeft] < array.strong16[numRight]){
