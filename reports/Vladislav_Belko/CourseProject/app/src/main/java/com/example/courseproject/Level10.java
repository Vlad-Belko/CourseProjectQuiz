...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_10);
        ...
        textDescription.setText(R.string.level_10);
        ...
        textDescriptionEnd.setText(R.string.level_10_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level10.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images10[numLeft]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong10[numLeft] < array.strong10[numRight]){
