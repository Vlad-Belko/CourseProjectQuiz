...
public class Level21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level21);
        ...
        previewImage.setImageResource(R.drawable.preview_img_21);
        ...
        textDescription.setText(R.string.level_21);
        ...
        textDescriptionEnd.setText(R.string.level_21_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level21.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images21[numLeft]);
        text_left.setText(array.texts21[numLeft]);
        ...
        text_right.setText(array.texts21[numRight]);
