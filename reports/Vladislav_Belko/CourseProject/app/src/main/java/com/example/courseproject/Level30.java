...
public class Level30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level30);
        ...
        previewImage.setImageResource(R.drawable.preview_img_30);
        ...
        textDescription.setText(R.string.level_30);
        ...
        textDescriptionEnd.setText(R.string.level_30_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level30.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(18);
        img_left.setImageResource(array.images30[numLeft]);
        text_left.setText(array.texts30[numLeft]);
        ...
        text_right.setText(array.texts30[numRight]);
