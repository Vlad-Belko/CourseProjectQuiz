...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_6);
        ...
        textDescription.setText(R.string.level_6);
        ...
        textDescriptionEnd.setText(R.string.level_6_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level6.this, R.anim.alpfa);
