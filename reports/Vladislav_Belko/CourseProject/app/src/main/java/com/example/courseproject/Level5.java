...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_5);
        ...
        textDescription.setText(R.string.level_5);
        ...
        textDescriptionEnd.setText(R.string.level_5_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level5.this, R.anim.alpfa);
