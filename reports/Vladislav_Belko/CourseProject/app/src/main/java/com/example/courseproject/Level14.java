...
public class Level14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_14);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level14.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images14[numLeft]);
        text_left.setText(array.texts14[numLeft]);
        ...
        text_right.setText(array.texts14[numRight]);
