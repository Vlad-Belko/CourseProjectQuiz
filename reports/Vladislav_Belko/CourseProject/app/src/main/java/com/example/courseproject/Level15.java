...
public class Level15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_15);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level15.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images15[numLeft]);
        text_left.setText(array.texts15[numLeft]);

        numRight = random.nextInt(20);

        while (array.strong15[numLeft] == array.strong15[numRight]){
            numRight = random.nextInt(20);
        }
        img_right.setImageResource(array.images15[numRight]);
        text_right.setText(array.texts15[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong15[numLeft] < array.strong15[numRight]){
