...
public class Level28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level28);
        ...
        previewImage.setImageResource(R.drawable.preview_img_28);
        ...
        textDescription.setText(R.string.level_28);
        ...
        textDescriptionEnd.setText(R.string.level_28_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level28.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images28[numLeft]);
        text_left.setText(array.texts28[numLeft]);

        numRight = random.nextInt(20);

        while (array.strong28[numLeft] == array.strong28[numRight]){
            numRight = random.nextInt(20);
        }
        img_right.setImageResource(array.images28[numRight]);
        text_right.setText(array.texts28[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong28[numLeft] < array.strong28[numRight]){
