...
public class Level23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level23);
        ...
        previewImage.setImageResource(R.drawable.preview_img_23);
        ...
        textDescription.setText(R.string.level_23);
        ...
        textDescriptionEnd.setText(R.string.level_23_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level23.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images23[numLeft]);
        text_left.setText(array.texts23[numLeft]);
        ...
        text_right.setText(array.texts23[numRight]);
