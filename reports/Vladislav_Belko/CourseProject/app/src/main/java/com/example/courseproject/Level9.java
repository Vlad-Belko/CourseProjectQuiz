...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_9);
        ...
        textDescription.setText(R.string.level_9);
        ...
        textDescriptionEnd.setText(R.string.level_9_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level9.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images9[numLeft]);
