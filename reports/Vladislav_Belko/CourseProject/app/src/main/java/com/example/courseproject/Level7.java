...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_7);
        ...
        textDescription.setText(R.string.level_7);
        ...
        textDescriptionEnd.setText(R.string.level_7_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level7.this, R.anim.alpfa);
