...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDescription.setText(R.string.level_3);
        ...
        textDescriptionEnd.setText(R.string.level_3_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level3.this, R.anim.alpfa);
