...
public class Level20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_20);
        ...
        textDescription.setText(R.string.level_20);
        ...
        textDescriptionEnd.setText(R.string.level_20_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level20.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images20[numLeft]);
        text_left.setText(array.texts20[numLeft]);
        ...
        text_right.setText(array.texts20[numRight]);
