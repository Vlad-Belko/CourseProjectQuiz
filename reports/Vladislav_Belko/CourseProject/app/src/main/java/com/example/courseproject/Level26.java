...
public class Level26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level26);
        ...
        previewImage.setImageResource(R.drawable.preview_img_26);
        ...
        textDescription.setText(R.string.level_26);
        ...
        textDescriptionEnd.setText(R.string.level_26_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level26.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images26[numLeft]);
        text_left.setText(array.texts26[numLeft]);

        numRight = random.nextInt(20);

        while (array.strong26[numLeft] == array.strong26[numRight]){
            numRight = random.nextInt(20);
        }
        img_right.setImageResource(array.images26[numRight]);
        text_right.setText(array.texts26[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong26[numLeft] < array.strong26[numRight]){
