...
public class Level27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level27);
        ...
        previewImage.setImageResource(R.drawable.preview_img_27);
        ...
        textDescription.setText(R.string.level_27);
        ...
        textDescriptionEnd.setText(R.string.level_27_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level27.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images27[numLeft]);
        text_left.setText(array.texts27[numLeft]);

        numRight = random.nextInt(20);

        while (array.strong27[numLeft] == array.strong27[numRight]){
            numRight = random.nextInt(20);
        }
        img_right.setImageResource(array.images27[numRight]);
        text_right.setText(array.texts27[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong27[numLeft] < array.strong27[numRight]){
