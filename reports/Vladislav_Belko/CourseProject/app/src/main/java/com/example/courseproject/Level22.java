...
public class Level22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_22);
        ...
        textDescription.setText(R.string.level_22);
        ...
        textDescriptionEnd.setText(R.string.level_22_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level22.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images22[numLeft]);
        text_left.setText(array.texts22[numLeft]);
        ...
        text_right.setText(array.texts22[numRight]);
