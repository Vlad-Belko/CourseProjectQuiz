...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDescription.setText(R.string.level_4);
        ...
        textDescriptionEnd.setText(R.string.level_4_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level4.this, R.anim.alpfa);
