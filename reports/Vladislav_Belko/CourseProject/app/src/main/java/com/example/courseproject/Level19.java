...
public class Level19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_19);
        ...
        textDescription.setText(R.string.level_19);
        ...
        textDescriptionEnd.setText(R.string.level_19_end);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level19.this, R.anim.alpfa);
        //  Подключаем анимацию - конец

        numLeft = random.nextInt(20);
        img_left.setImageResource(array.images19[numLeft]);
        text_left.setText(array.texts19[numLeft]);

        numRight = random.nextInt(20);

        while (array.strong19[numLeft] == array.strong19[numRight]){
            numRight = random.nextInt(20);
        }
        img_right.setImageResource(array.images19[numRight]);
        text_right.setText(array.texts19[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    // Касание - начало
                    if(array.strong19[numLeft] < array.strong19[numRight]){
